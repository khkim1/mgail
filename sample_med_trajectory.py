...
def argparser():
    ...
    parser.add_argument('--model', help='filename of model to test', default='trained_models/ppo/med/model.ckpt')
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(args.iteration):  # episode
            ...
            open_file_and_save('mtrajectory/observations.csv', observations)
            open_file_and_save('mtrajectory/actions.csv', actions)
            open_file_and_save('mtrajectory/reset_idx.csv', reset_idx)
