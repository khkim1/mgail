...
def main(args):
    ...
    Policy = Model_Policy_net('policy', env, num_obs_per_state*(obs_dim+act_dim))
    Old_Policy = Model_Policy_net('old_policy', env, num_obs_per_state*(obs_dim+act_dim))
    ...
    print("Number of Demonstrations: {}".format(len(expert_observations)))
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(args.iteration):
            ...
            print("Iteration: {}, Rewards: {}".format(iteration, sum(rewards)), end='\r')
