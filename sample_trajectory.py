...
def argparser():
    ...
    parser.add_argument('--model', help='filename of model to test', default='trained_models/ppo/expert/model.ckpt')
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(args.iteration):  # episode
            ...
            open_file_and_save('trajectory/reset_idx.csv', reset_idx)
